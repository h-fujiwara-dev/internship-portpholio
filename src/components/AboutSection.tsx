  ...
  return (
    <div className="w-full border border-[var(--ig-frame-border)] p-[1em]">
      ...
      <div className="mt-[1em] space-y-4 text-[#333]">
        <p>
          インターンコンパスは、日本全国の企業の情報を掲載したインターンシップ総合サイトです。
        </p>
        <p>
        ...
        <p>
          また1年生から参加出来る就活イベント情報や人気企業の内定者のES(エントリーシート)や就活体験談などの会員限定コンテンツを始め、企業とのメールや電話の仕方や、服装のマナー、面接対策など、就活にも役立つコラムも多数掲載しています。インターンコンパスを利用して大学生活をもっと有意義にしよう！
        </p>
      </div>
